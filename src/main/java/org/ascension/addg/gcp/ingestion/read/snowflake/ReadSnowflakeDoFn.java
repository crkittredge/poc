...
/**
 * Implementation for reading records from Snowflake
 */
public class ReadSnowflakeDoFn extends ReaderDoFn<Row> {

    public ReadSnowflakeDoFn(ReadSnowflakeStep config, TupleTag<Row> recordsTag, TupleTag<Row> badRecordsTag, TupleTag<Map<String, Schema>> schemaTag, TupleTag<Map<String, Schema>> badSchemaTag) {
