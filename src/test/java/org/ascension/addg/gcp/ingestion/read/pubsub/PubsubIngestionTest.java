...
/**
 * Tests transform-level Pub/Sub reader scenarios
 */
@RunWith(Parameterized.class)
public class PubsubIngestionTest extends IngestionTest.Setup {
     ...
     */
    public PubsubIngestionTest(String confFile) {
        super(BaseTest.PIPELINE_ARGS, IngestionOptions.class, Ingestion.class);
        this.confFile = confFile;
        this.readerMock = mock(PubsubReader.class);
